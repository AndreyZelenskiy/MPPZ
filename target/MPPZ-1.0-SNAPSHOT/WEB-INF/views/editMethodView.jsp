...
<div class="container">
    ...
    <form method="post" action="/admin/dev/edit">
        ...
        <div class="row" style="margin-top: 50px">
            ...
            <div class="col-md-12">
                ...
                <input class="form-control" name="methodName" type="text" value="${methodName}" id="name" disabled="disabled"/>
                <input name="methodName" type="hidden" value="${methodName}"/>
                <br>
                ...
                <textarea class="form-control" id="comment" name="methodText" rows="5">"${methodText}</textarea>
                <br>
                <div align="right">
